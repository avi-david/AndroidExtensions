package com.avinashdavid.androidextensions.coroutine
...
private class AndroidContinuation<T>(val cont: Continuation<T>) : Continuation<T> by cont {
    ...
    override fun resumeWithException(exception: Throwable) {
        Log.e(getLogTagForFile("AndroidCoroutineContext"), "Exception in AndroidContinuation.resumeWithException", exception)
